    ...
    public partial class SeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "datetime2",
                nullable: false,
                defaultValue: new DateTime(2021, 1, 5, 14, 51, 55, 412, DateTimeKind.Local).AddTicks(4718),
                oldClrType: typeof(DateTime),
                oldType: "datetime2",
                oldDefaultValue: new DateTime(2021, 1, 4, 19, 20, 56, 712, DateTimeKind.Local).AddTicks(8713));
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "HomeKeyword", "This is home page of eShopSolution" },
                    { "HomeDescription", "This is home page of eShopSolution" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 1, 5, 14, 51, 55, 425, DateTimeKind.Local).AddTicks(46), 100000m, 200000m, null });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "datetime2",
                nullable: false,
                defaultValue: new DateTime(2021, 1, 4, 19, 20, 56, 712, DateTimeKind.Local).AddTicks(8713),
                oldClrType: typeof(DateTime),
                oldType: "datetime2",
                oldDefaultValue: new DateTime(2021, 1, 5, 14, 51, 55, 412, DateTimeKind.Local).AddTicks(4718));
        }
    }
}
